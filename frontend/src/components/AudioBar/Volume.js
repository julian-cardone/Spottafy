...
const VolumeButtons = ({ audioElement, currentSong }) => {
  ...
  const volume1 =
    "M 9.741 0.85 a 0.75 0.75 0 0 1 0.375 0.65 v 13 a 0.75 0.75 0 0 1 -1.125 0.65 l -6.925 -4 a 3.642 3.642 0 0 1 -1.33 -4.967 a 3.639 3.639 0 0 1 1.33 -1.332 l 6.925 -4 a 0.75 0.75 0 0 1 0.75 0 Z m -6.924 5.3 a 2.139 2.139 0 0 0 0 3.7 l 5.8 3.35 V 2.8 l -5.8 3.35 Z m 8.683 4.29 V 5.56 a 2.75 2.75 0 0 1 0 4.88 Z";
  const volume2 =
    "M 11.5 13.614 a 5.752 5.752 0 0 0 0 -11.228 v 1.55 a 4.252 4.252 0 0 1 0 8.127 v 1.55 Z";
  const volume3 =
    "M 13.86 5.47 a 0.75 0.75 0 0 0 -1.061 0 l -1.47 1.47 l -1.47 -1.47 A 0.75 0.75 0 0 0 8.8 6.53 L 10.269 8 l -1.47 1.47 a 0.75 0.75 0 1 0 1.06 1.06 l 1.47 -1.47 l 1.47 1.47 a 0.75 0.75 0 0 0 1.06 -1.06 L 12.39 8 l 1.47 -1.47 a 0.75 0.75 0 0 0 0 -1.06 Z";
  const volume4 =
    ...
    <>
      <button className="mute-button" onClick={muteAudio}>
        <svg
          ...
          className="svg-mute"
        >
          <path className="mute-svg-1" d={vol1}></path>
          <path className="mute-svg-2" d={vol2}></path>
        </svg>
      </button>
      <div
